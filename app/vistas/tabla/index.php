            ...
            foreach ($datos['filas'] as $fila) {
                echo "
					<tr>
						...
						<td>
							<a class='boton' href='?menu=articulos&submenu=form_modificar&id={$fila['id_usuario']}' >modificar</a>
							<a class='boton' href='?menu=articulos&submenu=form_borrar&id={$fila['id_usuario']}' >borrar</a>
						</td>
					</tr>
					";
            }
