...
<html lang='<?php echo \core\Idioma::get(); ?>'>
	<head>
		...
		<script type="text/javascript" >
			/* líneas del script */
			function saludo() {
				alert("Bienvenido al primer ejercicio de Desarrollo Web en Entorno Servidorsadasdasd");
			}
		</script>
...
<!--						<li class="item"><a href="<?php //echo \core\URL::generar("articulos"); ?>" title="Artículos">Artículos</a></li>-->
		...
		<div id="pie">
			...
			Documento creado por Miguel Gascón  <a href="mailto:jequeto@gmail.com">Contactar</a><br />
			Fecha última actualización: 29 de enero de 2014.
		</div>
